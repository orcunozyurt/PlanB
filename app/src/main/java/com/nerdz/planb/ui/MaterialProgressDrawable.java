...
public class MaterialProgressDrawable extends Drawable implements Animatable {
    ...
    private final Callback mCallback = new C07591();
    boolean mFinishing;
    ...
    class C07591 implements Callback {
        C07591() {
        }
    ...
    private void setupAnimators() {
        ...
        Animation animation = new Animation() {
            public void applyTransformation(float interpolatedTime, Transformation t) {
                ...
                ring.setEndTrim(startingEndTrim + (MaterialProgressDrawable.START_CURVE_INTERPOLATOR.getInterpolation(interpolatedTime) * (MaterialProgressDrawable.MAX_PROGRESS_ARC - minProgressArc)));
